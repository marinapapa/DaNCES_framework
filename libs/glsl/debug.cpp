...
namespace glsl
{
  ...
  void GLDebugLogStdErr(GLenum source, GLenum type, GLuint id, GLenum severity,
  ...
  void GLDebugLogOnceStdErr(GLenum source, GLenum type, GLuint id, GLenum severity,
                            GLsizei length, const GLchar* message, const GLvoid*)
  {
