...
namespace glsl {
  ...
  void Camera::setPerspectiveViewport(const glm::dvec4& viewport, double fovy, double clipNear, double clipFar)
  {
    viewport_ = viewport;
  ...
  void Camera::setOrthoViewport(const glm::dvec4& viewport, const glm::dvec4& world)
  {
    viewport_ = viewport;
  ...
  void Camera::setR(const dmat4& R)
  {
    V_[0][0] = R[0][0];
    V_[0][1] = R[1][0];
    V_[0][2] = R[2][0];
