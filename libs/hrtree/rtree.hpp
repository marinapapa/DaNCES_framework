...
// Copyright (c) 2000-2024 Hanno Hildenbrandt
//
...
namespace hrtree {
  ...
  class rtree : public rtree_base<BV, BP, FANOUT, A>
  {
    ...
    using typename base_type::stack_element;
  
  public:
    using base_type::bv_align;
    using typename base_type::bv_type;
    using typename base_type::bv_reference;
    using typename base_type::bv_iterator;
    using typename base_type::const_bv_iterator;
    using typename base_type::build_policy;
