#ifndef PERSONALIZED_IMGUI_INCLUDED
#define PERSONALIZED_IMGUI_INCLUDED

#include "imgui_unit.h"


#define PERSONALIZED_IMGUI_STYLES


namespace personalized_imgui
{

#ifndef PERSONALIZED_IMGUI_STYLES

	class ColorThemeEditor {
	public:
